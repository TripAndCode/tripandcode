        ...
        <footer className="mx-10 py-6 ">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://www.instagram.com/trip_and_code/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <BsInstagram />
                    </a>
                    <a href="https://twitter.com/trip_and_code" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <BsTwitter />
                    </a>
                    {/* <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
